...
// ToastProvider remains unchanged as it directly wraps the Radix UI ToastPrimitives.Provider
const ToastProvider = ToastPrimitives.Provider;

// Define props interface for ToastViewport
interface ToastViewportProps extends React.ComponentPropsWithoutRef<typeof ToastPrimitives.Viewport> {
  className?: string;
}

// ToastViewport component with TypeScript types
...
// Define props interface for Toast, including variant props from cva
...
// Toast component with TypeScript types
